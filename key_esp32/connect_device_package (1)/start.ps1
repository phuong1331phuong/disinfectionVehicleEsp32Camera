...
node .\node_modules\aws-iot-device-sdk\examples\device-example.js --host-name a3ylcu9d7zkfu-ats.iot.ap-southeast-1.amazonaws.com --private-key .\ESP32.private.key --client-certificate .\ESP32.cert.pem --ca-certificate .\root-CA.crt --client-id=sdk-nodejs-3a3bac17-2d7c-45bb-aa91-ca0fff218d62
